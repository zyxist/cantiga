...
/**
 * The event subscriber must be added to every form with custom form definition
 * support. It binds the validation rules of the embedded custom form with the
 * actual form. Without it, the validation won't work correctly!
 *
