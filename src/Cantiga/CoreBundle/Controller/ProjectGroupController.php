...
use Cantiga\CoreBundle\Form\ProjectAreaGroupForm;
...
class ProjectGroupController extends ProjectPageController
{
	...
	public function initialize(Request $request, AuthorizationCheckerInterface $authChecker)
	{
		$this->crudInfo = $this->newCrudInfo(self::REPOSITORY_NAME)
			->setTemplateLocation('CantigaCoreBundle:ProjectAreaGroup:')
	...
	public function ajaxListAction(Request $request)
	{
		$routes = $this->dataRoutes()
			->link('info_link', 'project_area_group_info', ['id' => '::id', 'slug' => $this->getSlug()])
			->link('edit_link', 'project_area_group_edit', ['id' => '::id', 'slug' => $this->getSlug()])
			->link('remove_link', 'project_area_group_remove', ['id' => '::id', 'slug' => $this->getSlug()]);
	...
	public function insertAction(Request $request)
	{
		...
		$action = new InsertAction($this->crudInfo, $item, new ProjectAreaGroupForm());
		$action->slug($this->getSlug());
	...
	{
		$action = new EditAction($this->crudInfo, new ProjectAreaGroupForm());
		$action->slug($this->getSlug());
