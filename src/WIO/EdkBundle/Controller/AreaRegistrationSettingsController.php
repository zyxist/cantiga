...
/**
 * @Route("/area/{slug}/participants/registration-settings")
 * @Security("is_granted('PLACE_MEMBER')")
 */
class AreaRegistrationSettingsController extends AreaPageController
{
	...
	public function initialize(Request $request, AuthorizationCheckerInterface $authChecker)
	{
		...
		$this->crudInfo = $this->newCrudInfo($repository)
			...
			->setIndexPage('area_reg_settings_index')
			->setInfoPage('area_reg_settings_info')
			->setEditPage('area_reg_settings_edit')
	...
	/**
	 * @Route("/index", name="area_reg_settings_index")
	 */
	public function indexAction(Request $request)
	{
		return $this->performIndex('area_reg_settings_ajax_list', $request);
	}

	/**
	 * @Route("/ajax-list", name="area_reg_settings_ajax_list")
	 */
	...
	/**
	 * @Route("/{id}/info", name="area_reg_settings_info")
	 */
	public function infoAction($id, Request $request)
	{
		return $this->performInfo($id, 'area_route_info', '', $request);
	}

	/**
	 * @Route("/{id}/edit", name="area_reg_settings_edit")
	 */
