...
/**
 * Common code for EWC registration settings.
 *
 * @author Tomasz Jędrzejewski
 */
trait RegistrationSettingsTrait
{
	protected function performIndex($ajaxListLink, Request $request)
	{
