...
class GroupRegistrationSettingsController extends GroupPageController
{
	...
	public function initialize(Request $request, AuthorizationCheckerInterface $authChecker)
	{
		...
		$this->crudInfo = $this->newCrudInfo($repository)
			...
			->setIndexPage('group_reg_settings_index')
			->setInfoPage('group_reg_settings_info')
			->setEditPage('group_reg_settings_edit')
	...
	/**
	 * @Route("/index", name="group_reg_settings_index")
	 */
	public function indexAction(Request $request)
	{
		return $this->performIndex('group_reg_settings_ajax_list', $request);
	}

	/**
	 * @Route("/ajax-list", name="group_reg_settings_ajax_list")
	 */
	...
	/**
	 * @Route("/{id}/info", name="group_reg_settings_info")
	 */
	public function infoAction($id, Request $request)
	{
		return $this->performInfo($id, 'group_route_info', 'group_area_info', $request);
	}

	/**
	 * @Route("/{id}/edit", name="group_reg_settings_edit")
	 */
